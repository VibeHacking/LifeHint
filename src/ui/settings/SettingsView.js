    ...
    static styles = css`
        * {
        ...
        .provider-key-group input {
            ...
            color: white; border-radius: 10px; padding: 5px 8px; font-size: 11px; box-sizing: border-box;
        }
        ...
        .model-list {
            ...
            overflow-y: auto; background: rgba(0,0,0,0.3); border-radius: 10px;
                            ...
                            return html`
                                <div class="provider-key-group">
                                    ...
                                    ${this.ollamaStatus.installed && this.ollamaStatus.running ? html`
                                        <div style="padding: 8px; background: rgba(0,255,0,0.1); border-radius: 10px; font-size: 11px; color: rgba(0,255,0,0.8);">
                                            ✓ Ollama is running
                                        </div>
                                    ...
                                    ` : this.ollamaStatus.installed ? html`
                                        <div style="padding: 8px; background: rgba(255,200,0,0.1); border-radius: 10px; font-size: 11px; color: rgba(255,200,0,0.8);">
                                    ...
                                    ` : html`
                                        <div style="padding: 8px; background: rgba(255,100,100,0.1); border-radius: 10px; font-size: 11px; color: rgba(255,100,100,0.8);">
                            ...
                            return html`
                                <div class="provider-key-group">
                                    ...
                                    ${this.apiKeys[id] === 'local' ? html`
                                        <div style="padding: 8px; background: rgba(0,255,0,0.1); border-radius: 10px; font-size: 11px; color: rgba(0,255,0,0.8); margin-bottom: 8px;">
                                            ✓ Whisper is enabled
                                        </div>
