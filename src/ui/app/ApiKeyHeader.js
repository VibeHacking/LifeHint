...
export class ApiKeyHeader extends LitElement {
    ...
    _renderFailedState(state) {
        return html`
            <div style="margin-top: 6px; padding: 8px; background: rgba(239,68,68,0.1); border-radius: 16px;">
    ...
    _renderUnknownState() {
        return html`
            <div style="margin-top: 6px; padding: 8px; background: rgba(255,200,0,0.1); border-radius: 16px;">
